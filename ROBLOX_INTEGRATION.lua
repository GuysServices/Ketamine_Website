...
--[[
    KETAMINE DASHBOARD INTEGRATION
...
-- CONFIGURATION
local DASHBOARD_URL = "https://ketaminev2.vercel.app" -- Replace with your actual Vercel URL if different
...
local function sendHeartbeat()
    ...
    if success then
        print("[Ketamine] Heartbeat sent successfully.")
    else
        warn("[Ketamine] Failed to send heartbeat: " .. tostring(result))
    end
end
