...
const CATEGORIES = [
  {
    label: "💎 High Tiers",
    tiers: [
      { amount: "100,000 Robux", price: "$720.00", discord: true },
      { amount: "90,000 Robux",  price: "$648.00", discord: true },
      { amount: "80,000 Robux",  price: "$576.00", discord: true },
      { amount: "70,000 Robux",  price: "$504.00", discord: true },
      { amount: "60,000 Robux",  price: "$432.00", discord: true },
      { amount: "50,000 Robux",  price: "$360.00", discord: true },
      { amount: "45,000 Robux",  price: "$324.00", discord: true },
      { amount: "40,000 Robux",  price: "$288.00", discord: true },
    ],
  },
  {
    label: "💰 Mid Tiers",
    tiers: [
      { amount: "35,000 Robux", price: "$252.00", discord: true },
      { amount: "30,000 Robux", price: "$216.00", discord: true },
      { amount: "25,000 Robux", price: "$180.00", discord: true },
      { amount: "20,000 Robux", price: "$144.00", discord: true },
      { amount: "15,000 Robux", price: "$108.00", discord: true },
      { amount: "12,000 Robux", price: "$86.40",  discord: true },
    ],
  },
  {
    label: "🔥 Popular Tiers",
    tiers: [
      { amount: "10,000 Robux", price: "$72.00",  discord: true },
      { amount: "9,000 Robux",  price: "$64.80",  discord: true },
      { amount: "8,000 Robux",  price: "$57.60",  discord: true },
      { amount: "7,000 Robux",  price: "$50.40",  discord: true },
      { amount: "6,000 Robux",  price: "$43.20",  discord: true },
    ],
  },
  {
    label: "⭐ Best Budget Deal",
    tiers: [
      { amount: "5,000 Robux", price: "$36.00", variantId: 1109544 },
    ],
  },
  {
    label: "📦 Standard & Low Tiers",
    tiers: [
      { amount: "4,000 Robux", price: "$28.80", variantId: 1109543 },
      { amount: "3,500 Robux", price: "$25.20", variantId: 1109542 },
      { amount: "3,000 Robux", price: "$21.60", variantId: 1109541 },
      { amount: "2,500 Robux", price: "$18.00", variantId: 1109540 },
      { amount: "2,000 Robux", price: "$14.40", variantId: 1109539 },
      { amount: "1,500 Robux", price: "$10.80", variantId: 1109502 },
      { amount: "1,000 Robux", price: "$7.20",  variantId: 1109501 },
      { amount: "800 Robux",   price: "$6.00",  variantId: 1109500 },
    ],
  },
]
