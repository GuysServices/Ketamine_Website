...
const CATEGORIES = [
  {
    label: " High Tiers",
    tiers: [
      { amount: "100,000 Robux", price: "$600", discord: true },
      { amount: "90,000 Robux",  price: "$540", discord: true },
      { amount: "80,000 Robux",  price: "$480", discord: true },
      { amount: "70,000 Robux",  price: "$420", discord: true },
      { amount: "60,000 Robux",  price: "$360", discord: true },
      { amount: "50,000 Robux",  price: "$300", discord: true },
      { amount: "45,000 Robux",  price: "$270", discord: true },
      { amount: "40,000 Robux",  price: "$240", discord: true },
    ],
  },
  {
    label: "⭐ Mid Tiers (BEST VALUE)",
    tiers: [
      { amount: "35,000 Robux", price: "$210", discord: true },
      { amount: "30,000 Robux", price: "$180", discord: true },
      { amount: "25,000 Robux", price: "$162.50", discord: true },
      { amount: "20,000 Robux", price: "$130",  discord: true },
      { amount: "15,000 Robux", price: "$97.50",  discord: true },
      { amount: "12,000 Robux", price: "$78",  discord: true },
    ],
  },
  {
    label: " Popular Tiers",
    tiers: [
      { amount: "10,000 Robux", price: "$65", discord: true },
      { amount: "9,000 Robux",  price: "$58.50", discord: true },
      { amount: "8,000 Robux",  price: "$52", discord: true },
      { amount: "7,000 Robux",  price: "$45.50", discord: true },
      { amount: "6,000 Robux",  price: "$39", discord: true },
    ],
  },
  {
    label: "💰 Budget Deal",
    tiers: [
      { amount: "5,000 Robux", price: "$35", variantId: 1109544 },
    ],
  },
  {
    label: "⚪ Standard & Low Tiers",
    tiers: [
      { amount: "4,000 Robux", price: "$28", variantId: 1109543 },
      { amount: "3,500 Robux", price: "$24.50", variantId: 1109542 },
      { amount: "3,000 Robux", price: "$21", variantId: 1109541 },
      { amount: "2,500 Robux", price: "$17.50", variantId: 1109540 },
      { amount: "2,000 Robux", price: "$14", variantId: 1109539 },
      { amount: "1,500 Robux", price: "$10.50",  variantId: 1109502 },
      { amount: "1,000 Robux", price: "$7",  variantId: 1109501 },
      { amount: "800 Robux",   price: "$5.60",  variantId: 1109500 },
    ],
  },
]
