--[[
    ...
    Captures console output and sends to Ketamine Dashboard.
...
local CONFIG = {
    DASHBOARD_URL = "https://ketaminev2.vercel.app",
...
local function sendBatch(batch, retryCount)
    ...
    if success then
        print("[Ketamine] Sent " .. #batch .. " logs successfully")
        return true
    else
        warn("[Ketamine] Failed to send logs: " .. tostring(result))
...
print("[Ketamine] Game Logs initialized for PlaceId: " .. tostring(game.PlaceId))
