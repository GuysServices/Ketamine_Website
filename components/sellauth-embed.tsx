    ...
    ({ onStateChange }, ref) => {
        ...
        useEffect(() => {
            ...
            const handleStateChange = (ev: Event) => {
                ...
                if (customEv.detail && 'payload' in customEv.detail) {
                    const payload = customEv.detail.payload || null;
                    setValue(payload);
                    onStateChange?.(customEv);
                }
            };
        ...
        // Using `as any` for style to bypass typing issues with web component.
        return createPortal(
            <altcha-widget
                ref={widgetRef}
    ...
    return createPortal(
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            <div
                ...
                onClick={onClose}
            />
            <div className="relative bg-[#1a0b2e] text-white rounded-xl max-w-[98vw] md:max-w-[32rem] w-full max-h-[90vh] overflow-hidden animate-in fade-in zoom-in-95 duration-200 border border-purple-500/20">
                <button
                    onClick={onClose}
    ...
    return (
        <>
            ...
            >
                {children || (
                    <>
                        <span>Purchase Ketamine License</span>
                        {!isLoading && (
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
